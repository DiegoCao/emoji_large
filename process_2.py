...
if __name__ == "__main__":
    ...
    dff1 = df_old.filter( (df_old.type=="PushEvent")| (df_old.type== "IssuesEvent") | (df_old.type=="IssueCommentEvent") | (df_old.type=="PullRequestReviewCommentEvent") | (df_old.type=="PullRequestReviewEvent"))
